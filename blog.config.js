...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '清望深山冬', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '我有一饮，为接风尘', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.atomicman.eu.org/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客,categoryurls.life', // 网站关键词 英文逗号隔开
